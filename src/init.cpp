...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/galaxychain-project/galaxychain>";
    const std::string URL_WEBSITE = "<http://galaxychain.club>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("galaxychain version %s\n", FormatFullVersion());
}
