...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s galaxychain-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  galaxychain-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded galaxychain transaction") + "\n" +
              "  galaxychain-tx [options] -create [commands]   " + _("Create hex-encoded galaxychain transaction") + "\n" +
              "\n";
