...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.galaxychain.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.galaxychaintools.com", true);
        vSeeds.emplace_back("dnsseed.galaxychainpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.galaxychaintools.com", true);
        vSeeds.emplace_back("seed-b.galaxychain.loshan.co.uk", true);
